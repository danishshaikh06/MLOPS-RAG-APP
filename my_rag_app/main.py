...
from my_rag_app.api.endpoint import router

__version__ = "0.0.1"

app = FastAPI(
    title="my-rag-app APIs",
    description="This is a template repository for Python GenAI RAG projects that use Poetry for their dependency management.",
    version=__version__,
    docs_url="/docs",
    redoc_url="/redoc",
)
